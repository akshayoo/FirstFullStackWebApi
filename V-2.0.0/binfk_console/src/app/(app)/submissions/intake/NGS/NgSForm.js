...
export function NgSForm({projectId}) {
    ...
    async function submitNGSForm() {
        ...
        if (!formData.application || !formData.extraction_needed || !formData.bioinformatics_needed || !formData.project_description) {toastSet(setToast, false, "Missing fields");return}
        ...
        <div className={styles.MainFormPage}>
            <div className={styles.FormBox}>
                <div className={styles.FormFirSec}>
                    ...
                    <div className={styles.FFComp}>
                        <div>Project Description, Objectives & Sample Information or anything that you want us to consider- Please avoid giving NIL *</div>
                        <textarea name="project_description" onChange={handleFieldChange} rows={5} />
                    </div>
